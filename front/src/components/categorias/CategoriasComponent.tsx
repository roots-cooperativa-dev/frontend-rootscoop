        ...
        <div className="container mx-auto max-w-4xl py-8 space-y-8">
                                ...
                                {editingId === id ? (
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Badge variant="secondary" className="bg-[#017d74]/10 text-[#017d74]">Activa</Badge>
                                            ...
                                            <AlertDialog>
                                                ...
                                                <AlertDialogContent>
                                                    <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogDescription>
                                                            Esta acción eliminará permanentemente la categoría <strong>{categoriaAEliminar?.name}</strong>.
                                                        </AlertDialogDescription>
                                                    </AlertDialogHeader>
                                                    <AlertDialogFooter>
            ...
            {totalPages > 1 && (
                <div className="flex justify-center items-center gap-4 mt-6">
                    ...
                    <Button onClick={() => setPage((prev) => Math.min(prev + 1, totalPages))} disabled={page === totalPages} variant="outline">
                        Siguiente
                    </Button>
                </div>
            )}
