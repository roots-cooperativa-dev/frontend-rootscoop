    ...
    async (
      ...
      try {
        const response = await fetchProductos({
          categoryId: filters.categorias?.length
        ...
        if (
          ...
          typeof (response as any).totalCount === "number"
        ) {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="font-bebas text-xl text-gray-700 max-w-3xl mx-auto font-medium">
            Productos con identidad cooperativa. Cada compra apoya nuestro
            trabajo colectivo y fortalece la red de{" "}
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-500">
                {name ? "Buscando productos..." : "Cargando productos..."}
              </p>
            </div>
          </div>
        ) : productos.length === 0 ? (
          <div className="text-center py-20">
            <div className="space-y-4">
              ...
              <p className="text-gray-500">
                {name
                  ? `No hay productos que coincidan con "${name}"`
