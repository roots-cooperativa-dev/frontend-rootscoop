        ...
        <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        <h3 className="font-bebas text-3xl font-popular mb-6 text-[#922f4e]">Desde 2013 construyendo comunidad</h3>
                        <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                            <p>
                                <span className="font-popular text-[#642d91]">ROOTS</span> nace en 2013 en La Plata como un sueño
                                compartido por un grupo de amigues que creían en otra forma de trabajar. No queríamos ser empleados,
                                queríamos ser <span className="font-popular text-[#922f4e]">dueños de nuestro tiempo</span> y de
                                nuestro trabajo.
                            </p>
                            <p>
                                Empezamos vendiendo cerveza artesanal en ferias y eventos. Poco a poco fuimos creciendo, sumando
                                compañeres, aprendiendo a <span className="font-popular text-[#017d74]">tomar decisiones juntos</span>.
                                Hoy somos <span className="font-popular text-[#febb07]">11 asociados</span> que construimos día a día
                            ...
                            <p>
                                ...
                                <span className="font-popular text-[#922f4e]"> red de vínculos</span> con otras cooperativas,
                            ...
                            <p>
                                ...
                                político. Es decir <span className="font-popular text-[#017d74]">"se puede vivir de otra manera"</span>
