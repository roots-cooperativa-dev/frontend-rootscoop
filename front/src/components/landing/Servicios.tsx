            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="hover:shadow-2xl transition-all transform hover:-translate-y-3 border-2 border-[#922f4e]/20 hover:border-[#922f4e]">
                    <CardHeader className="text-center">
                        ...
                        <CardTitle className="text-[#922f4e] font-bold">Productos</CardTitle>
                        <CardDescription className="font-medium">Merch y productos con identidad cooperativa</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="hover:shadow-2xl transition-all transform hover:-translate-y-3 border-2 border-[#017d74]/20 hover:border-[#017d74]">
                    <CardHeader className="text-center">
                        ...
                        <CardTitle className="text-[#017d74] font-bold">Visitas</CardTitle>
                        <CardDescription className="font-medium">Conocé nuestra planta de investigación</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button className="w-full bg-[#922f4e] hover:bg-[#642d91] text-white font-bold shadow-lg" asChild>
                ...
                <Card className="hover:shadow-2xl transition-all transform hover:-translate-y-3 border-2 border-[#febb07]/20 hover:border-[#febb07]">
                    <CardHeader className="text-center">
                        ...
                        <CardTitle className="text-[#f39d10] font-bold">Donaciones</CardTitle>
                        <CardDescription className="font-medium">Apoyá nuestro trabajo cooperativo</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button className="w-full bg-[#922f4e] hover:bg-[#642d91] text-white font-bold shadow-lg" asChild>
                ...
                <Card className="hover:shadow-2xl transition-all transform hover:-translate-y-3 border-2 border-[#642d91]/20 hover:border-[#642d91]">
                    <CardHeader className="text-center">
                        ...
                        <CardTitle className="text-[#642d91] font-bold">Ubicaciones</CardTitle>
                        <CardDescription className="font-medium">Ferias, nodos y almacenes</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Button className="w-full bg-[#922f4e] hover:bg-[#642d91] text-white font-bold shadow-lg" asChild>
