...
const GOOGLE_MAPS_LINK =
  "https://www.google.com.ar/maps/place/Roots+Pizza/@-34.9209676,-57.9507011,17z/data=!3m1!4b1!4m6!3m5!1s0x95a2e625a88546ef:0xa751095adb320f2b!8m2!3d-34.920972!4d-57.9481262!16s%2Fg%2F11b8_n1rz1?hl=es&entry=ttu&g_ep=EgoyMDI1MDcwOC4wIKXMDSoASAFQAw%3D%3D";
...
const reviews = [
  ...
  {
    text: "Buenos ingredientes, un precio justo por la calidad y un compromiso social, un ambiente y servicio cálidos, un lugar centrado en la gente, limonada y pan muy saludables y sabrosos, una fachada magnífica que refleja todos los valores de Roots, ¿qué más puedo decir? ¡Anímate!😘",
    author: "Laureline MGMT",
    color: "#642d91",
    avatar: null,
    rating: 5,
    date: "Hace 1 Mes",
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {reviews.map((review, idx) => (
          <Card
            key={idx}
            className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-2xl transition-all h-full flex flex-col"
          >
