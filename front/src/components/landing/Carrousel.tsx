  ...
  const carouselItems = [
    {
      ...
      description:
        "Descubrí cómo nuestra cooperativa transforma la comunidad y construye alternativas reales en la economía social en este video producido por nuestro equipo de comunicacion.",
    ...
    },
    {
      id: 2,
      type: "visit",
      title: "Visita la Planta Experimental Mosca Soldado Negra",
      description:
        "Una experiencia donde podrás conocer nuestra planta de investigacion, y a la mosca que se alimenta de los restos del grano de la produccion de nuestra cerveza artesanal, aportando a la economia circular.",
  ...
  return (
    <div className="container mx-auto px-4">
      <div className="text-center mb-16">
        <h2 className="font-chewy text-4xl font-black text-[#017d74] mb-4">
          Explora ROOTS
        </h2>
        <p className="font-bebas text-xl text-gray-700 max-w-3xl mx-auto">
          Descubrí todas las formas de conocer y ser parte de nuestra
          cooperativa
        </p>
      </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-0 min-h-[500px]">
                    ...
                    <div className="p-8 md:p-12 flex flex-col justify-center order-1 md:order-2 bg-gray-50">
                      <CardHeader className="p-0 mb-6">
                        <CardTitle
                          className="font-chewy text-3xl md:text-4xl font-black mb-4"
