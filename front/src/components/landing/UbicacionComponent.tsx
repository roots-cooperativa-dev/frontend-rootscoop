...
export const UbicacionComponent = () => {
  ...
  const openInGoogleMaps = () => {
    const url = `https://www.google.com/maps/place/Roots+Pizza/@-34.92082,-57.9486181,19.05z/data=!4m12!1m5!3m4!2zMzTCsDU1JzE1LjAiUyA1N8KwNTYnNTMuMyJX!8m2!3d-34.92084!4d-57.9481262!3m5!1s0x95a2e625a88546ef:0xa751095adb320f2b!8m2!3d-34.920972!4d-57.9481262!16s%2Fg%2F11b8_n1rz1?entry=ttu&g_ep=EgoyMDI1MDgxMy4wIKXMDSoASAFQAw%3D%3D`;
    ...
    <div className="w-full max-w-7xl mx-auto space-y-8 p-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Visítanos en nuestro local en La Plata. Estamos aquí brindarte la
          mejor experiencia.
        </p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-xl border-2 border-[#017d74]/20 bg-gradient-to-br from-white to-[#017d74]/5">
            <CardHeader className="text-center pb-6">
              ...
              <CardTitle className="text-2xl text-[#017d74] mb-2">
                ROOTS Cooperativa
              </CardTitle>
              <Badge className="bg-[#017d74] text-white px-4 py-1 text-sm">
                Economía Social
              </Badge>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-gray-700">La Plata</p>
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Martes a sabados de 12 a 15 hs y de 19 a 23 hs
                  </p>
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Telefono fijo +54 2214235656</p>
                  <p className="text-gray-700">Wathsapp +54 2215606991</p>
        ...
        <div className="space-y-6">
          <Card className="shadow-xl overflow-hidden border-2 border-[#017d74]/20">
            <CardHeader className="bg-gradient-to-r from-[#017d74] to-[#015d54] text-white">
              ...
              <p className="text-[#017d74]/20 text-sm">
                Haz clic en el marcador para más información
              </p>
            </CardHeader>
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">
                      C. 10 1182, La Plata • A 5 min del centro
                    </p>
                  </div>
                </div>
              </div>
        ...
        <Card className="shadow-xl border-2 border-[#017d74]/20">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <Link
                href="https://www.instagram.com/roots_cooperativa/"
                target="_blank"
                className="group"
              >
                <Button
      ...
      <Card className="shadow-xl border-2 border-[#017d74]/20">
        <CardHeader className="text-center bg-gradient-to-r from-[#017d74]/5 to-[#015d54]/5">
          ...
          <p className="text-gray-600">
            Múltiples opciones para llegar fácilmente
          </p>
        </CardHeader>
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-purple-700 font-medium">
                  No hay estacionamiento medido
                </p>
                <p className="text-sm text-purple-600">
                  Entrada por Calle diagonal 73
                </p>
              </div>
            </div>
          </div>
