      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="font-popular text-gray-300 text-lg leading-relaxed">
              Cooperativa de Trabajo gastronómica y cultural. Construyendo desde
              2013. Cervezas, pizzas, empanadas, catering, eventos, panificados,
              ensaladas con mucho amor ♥
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              <p className="font-popular text-lg">10 N° 1182</p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center">
          <p className="text-gray-400 text-lg">
            &copy; 2025 ROOTS Cooperativa de Trabajo Ltda. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
